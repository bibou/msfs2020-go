...
// build: GOOS=windows GOARCH=amd64 go build -o vfrmap.exe github.com/bibou/msfs2020-go/vfrmap
...
import (
	...
	"github.com/bibou/msfs2020-go/simconnect"
	"github.com/bibou/msfs2020-go/vfrmap/html/leafletjs"
	"github.com/bibou/msfs2020-go/vfrmap/websockets"
)
...
func main() {
	...
	fmt.Printf("\nmsfs2020-go/vfrmap\n  readme: https://github.com/bibou/msfs2020-go/blob/master/vfrmap/README.md\n  issues: https://github.com/bibou/msfs2020-go/issues\n  version: %s (%s)\n\n", buildVersion, buildTime)
